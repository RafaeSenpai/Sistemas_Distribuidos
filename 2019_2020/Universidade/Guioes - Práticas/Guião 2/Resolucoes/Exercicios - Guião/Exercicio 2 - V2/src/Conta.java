...
public class Conta {
    ...
    /**Faz a comparação entre duas listagens de movimentos, este metodo é auxiliar no metodo equals*/
     ...
     *  é a versão do toString é a que se encontra imediatamente a baixo, que recorre á class StringBuilder
     * */
    ...
    /**Metodo auxiliar do to string da class Banco*/
