 ...
 * */
public class Exe3Slide1 implements Runnable{
    int contador=1;
    int valMax;
    ...
    public static void main(String[] args) {
        ...
        Exe3Slide1 instancia_1 = new Exe3Slide1(valor);
        Exe3Slide1 instancia_2 = new Exe3Slide1(valor);
        Exe3Slide1 instancia_3 = new Exe3Slide1(valor);
